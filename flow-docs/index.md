                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>基礎の概要</h3>
                                            <p>Microsoft Flow を使用して、仕事や生活をすばやく自動化する方法を紹介します。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>モバイル アプリについて理解する</h3>
                                            <p>いつでも、どこからでも、自動ワークフローを管理、追跡、探索します。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>今週の Flow を見る</h3>
                                            <p>Microsoft Flow チームから新しいテクニックを直接伝授します。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Microsoft Flow を使うと、反復的なタスクを簡単に自動化できます。 ユーザーまたはグループを所有者として追加し、共同作業によりフローの設計および管理ができます。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>組織の Microsoft Flow を管理する</h3>
                                            <p>Microsoft Flow で環境を作成、使用、管理する方法を学習します。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>独自のアプリケーションから Microsoft Flow を呼び出します。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Azure Logic Apps、Microsoft Flow、または Microsoft PowerApps で使用できるカスタム コネクタを作成します。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
