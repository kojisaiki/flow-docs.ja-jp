...
**注**: 環境はユーザーからは見えないものであるため、ユーザーは自分がどの環境に属しているかを意識する必要はありません。 環境は、監理者が組織のアプリとフローを分類し、管理し、共有するためのツールです。  
...
**注**: Microsoft Flow へのアクセス権が与えられているユーザーは誰でも、既定環境にアクセスできます。 ユーザーには、複数の環境へのアクセスを与えることができます。  
